...
data_show_map:                    
data_keywords: 6-2-ab,6.2.ab,6.2.a, b                   
data_start_values:                    
...
<div>                           
  <div class="my-header">                           
    <h3>a) Trinkwasserzugang                           
    </h3>                           
  </div>                           
</div>                           
<div>                           
  <div class="my-header">                           
    <h3>b) Anschluss an Abwasserentsorgung                           
    </h3>                           
  </div>                           
</div>